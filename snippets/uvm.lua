...
local function testf()
	rawtest = vim.fn.system({"/home/ryanhunter/GitHub/nvims/test/testshell.rb"})
...
ls.add_snippets("systemverilog", {
	s("function newcomp",{
		t({"function new(string name=\""}),i(1),t({"\",uvm_component parent=null); // ##{{{"}),
		t({"","\tsuper.new(name,parent);"}),
		i(0),
		t({"","endfunction // ##}}}"}),
	}),
	s("function newobj",{
		t({"function new(string name=\""}),i(1),t({"\"); // ##{{{"}),
		t({"","\tsuper.new(name);"}),
		i(0),
		t({"","endfunction // ##}}}"}),
	}),
	s("uvm_package", {
		t({"package "}),i(1,"<PackageName>"),t(";"),
		t({"","\t`include \"uvm_macros.svh\""}),
		t({"","\timport uvm_pkg::*;"}),
		t({"","\t"}),
		i(0),
		t({"","endpackage"})
	...
	s("uvm_info", {
		t({"`uvm_info("}),i(1,"<MsgID>"),t(",$sformatf("),i(2,"<Message>"),t({"),"}),
		i(3,"UVM_LOW"),t(")"),
		i(0),
	}),
	s("connect", {
		t({"// TODO, To copy the prototype part into the class declaration",""}),
		t({"\textern function void connect_phase(uvm_phase phase);"}),
		t({"","// This code generated by snippet: 'connect', if has any issue, pls report to RyanHunter",""}),
		t({"","function void "}),i(1,"<ClassType>"),t("::"),t("connect_phase(uvm_phase phase); // ##{{{"),
	...
	s("driver", {
		...
		t({"","\tRhuDebugger debug; // mostly it comes from agent assignment"}),
		...
		t({"","\t`debug(\"local build_phase starting ...\")"}),
		t({"","\t`debug(\"local build_phase leaving ...\")"}),
		t({"","\tdebug.updateChildren(this);"}),
		t({"","endfunction // ##}}}"}),
	...
	s("component", {
		...
		t({"","\textern virtual function void build_phase(uvm_phase phase);"}),
		t({"","\textern virtual function void connect_phase(uvm_phase phase);"}),
		t({"","\textern virtual task run_phase(uvm_phase phase);"}),
		t({"","\t// ##}}}"}),
		t({"","endclass"}),
		t({"","function void "}),f(copy,1),t("::build_phase(uvm_phase phase); // ##{{{"),
		t({"","\tsuper.build_phase(phase);"}),
	...
	s("env", {
		t("// uvm_env: "),
		f(copy,1),
		t({"","// This class generated by snippet: 'env', if has any issue, pls report to RyanHunter"}),
		t({"","class "}),
		i(1),
		t({" extends uvm_env;"}),
		t({"","\tRhuDebugger debug;"}),
	...
	s("test", {
		t("// uvm_test: "),
		f(copy,1),
		t({"","// This class generated by snippet: 'test', if has any issue, pls report to RyanHunter"}),
		t({"","class "}),
		i(1),
		t({" extends uvm_test;"}),
		-- t({"","\tRhuDebugger debug;"}),
	...
	s("func", {
		t({"// TODO, To copy the prototype part into the class declaration",""}),
		t({"\textern function "}),i(1,"<returnType>"),t(" "),i(2,"<TaskName>"),t(" ("),i(3,"<Arguments>"),t(");"),
		t({"","// This code generated by snippet: 'func', if has any issue, pls report to RyanHunter",""}),
		t({"","function "}),f(copy,1),t(" "),i(4,"<ClassType>"),t("::"),f(copy,2),t("("),f(copy,3),t("); // ##{{{"),
		t({"","endfunction // ##}}}"}),
		i(0),
	}),
	s("if", {
